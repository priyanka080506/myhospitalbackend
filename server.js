...
app.use('/api/users', userRoutes);         // Example: /api/users/profile
app.use('/api/auth', authRoutes);         // Example: /api/auth/login, /api/auth/register
app.use('/api/doctors', doctorRoutes);    // Example: /api/doctors/all
app.use('/api/patients', patientRoutes);  // Example: /api/patients/:id
app.use('/api/appointments', appointmentRoutes); // Example: /api/appointments, /api/appointments/patient/:id
app.use('/api/reports', reportRoutes);    // Example: /api/reports, /api/reports/patient/:id
